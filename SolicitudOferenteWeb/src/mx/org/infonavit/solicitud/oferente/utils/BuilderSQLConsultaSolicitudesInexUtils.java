 ...
 *     consulta de solicitudes Inex. 
 * </p> 
 * @author Adrian Casas
 */
public class BuilderSQLConsultaSolicitudesInexUtils {
	
	private static final Logger LOGGER = LogManager.getLogger(BuilderSQLConsultaSolicitudesInexUtils.class);
	private static final String PREFIJO_LOG = "[BSQLCSIU] - ";
	 ...
	 */
	public static String generarSentencia(CriteriosConsultaSolicitudesInex criterios)
	{
	 ...
	 */
	public static String obtenerTablas(CriteriosConsultaSolicitudesInex criterios)
	{
		StringBuffer sentencia = null;
