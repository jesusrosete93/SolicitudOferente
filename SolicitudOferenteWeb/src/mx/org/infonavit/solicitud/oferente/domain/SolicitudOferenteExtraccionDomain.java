...
public class SolicitudOferenteExtraccionDomain extends GenericValueObject{
	...
	public SolicitudOferenteExtraccionDomain(String id_solicitud, String tipo_linea,
			 String id_oferente,
	...
	public SolicitudOferenteExtraccionDomain(String id_registro, String id_solicitud,
			...
			String nombre_archivo, byte[] archivo, String tipo_archivo) {
		super();
	...
	public SolicitudOferenteExtraccionDomain() {
