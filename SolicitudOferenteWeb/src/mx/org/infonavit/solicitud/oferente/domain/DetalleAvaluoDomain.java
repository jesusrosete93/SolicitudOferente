...
public class DetalleAvaluoDomain extends GenericValueObject {
	...
	public DetalleAvaluoDomain(String idAvaluo) {
		super();
	...
	public DetalleAvaluoDomain(String idAvaluo, int idVivienda, String idPaquete,
	...
	public boolean equals(Object obj) {
		if (obj instanceof DetalleAvaluoDomain)
		{
			return ((DetalleAvaluoDomain)obj).getIdAvaluo().trim().equals(this.idAvaluo.trim());
