...
public class ViviendaDomain extends GenericValueObject {
	 ...
	 * 
	 */
	public ViviendaDomain() {
		super();
	}

	

	public ViviendaDomain( String id_paquete,int id_vivienda) {
		super();
	...
	public ViviendaDomain(int id_vivienda, String id_paquete, String localidad,
	...
	*/
	...
	{
		if( object instanceof ViviendaVo)
		{
			return ((ViviendaVo)object).getId_paquete().trim().equals(this.id_paquete) && ((ViviendaVo)object).getId_vivienda()==this.id_vivienda;
		}else
		{
			return false;
		}
