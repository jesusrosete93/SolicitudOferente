...
@Controller
public class RegistroSolicitudModificacionOferenteController {
	
	private static final Logger LOGGER = LogManager.getLogger(RegistroSolicitudModificacionOferenteController.class);
...
//	
	...
	@RequestMapping(value="initSolicitudModificacionOferente.htm",method=RequestMethod.GET)
	public String inicializarSolicitudModifiacionOferente(Model model,HttpServletRequest request,HttpServletResponse response)
	{
		SolicitudOferenteModificacionForm forma = new SolicitudOferenteModificacionForm();
		...
		model.addAttribute("solicitudModificacion", forma);
		
		return "viewSolicitudModificacionOferente";
	}

	@RequestMapping(value="/insertarSolicitudModificacion.json",method=RequestMethod.POST)
	public @ResponseBody RespuestaJsonSolicitudCancelacionOferente procesarPeticionRegistroCanclacionOferente(@ModelAttribute("solicitudModificacion")SolicitudOferenteModificacionForm formulario,BindingResult result) throws BusinessException
