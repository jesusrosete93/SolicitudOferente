...
public class SolicitudOferenteIDVo extends GenericValueObject{
	...
	public SolicitudOferenteIDVo() {
		super();
		// TODO Apéndice de constructor generado automáticamente
	}
	
	public SolicitudOferenteIDVo(String consecutivo) {
		super();
	...
	public void setId_modificacion(String id_modificacion) {
		this.id_modificacion = so.getLinea();;
	}
