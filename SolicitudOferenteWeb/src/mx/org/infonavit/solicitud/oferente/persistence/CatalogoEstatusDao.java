 ...
 *
 */
@Repository("CatalogoEstatusDao")
public class CatalogoEstatusDao extends AbstractDao<EstatusVo> {
	
	public static boolean TODOS;
	
	private static String FIND = " SELECT * FROM Cat_estatus WITH(NOLOCK)";
	...
	private class CatalogoEstatusMapper implements RowMapper<EstatusVo>
	{
		...
		public EstatusVo mapRow(ResultSet resultSet, int fetch) throws SQLException {
			...
			return new EstatusVo( resultSet.getInt("id_estatus"),
