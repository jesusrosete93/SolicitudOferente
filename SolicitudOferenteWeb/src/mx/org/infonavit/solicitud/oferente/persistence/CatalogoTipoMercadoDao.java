 ...
 *
 */
@Repository("CatalogoTipoMercadoDao")
public class CatalogoTipoMercadoDao extends AbstractDao<CatalogoVO> {
	
	
	
	private static String FIND_ALL = " SELECT * FROM TC_tipo_mercado WITH(NOLOCK)";
	...
	private class CatalogoCampoMapper implements RowMapper<CatalogoVO>
	{
		...
		public CatalogoVO mapRow(ResultSet resultSet, int fetch) throws SQLException {
			...
			return new CatalogoVO( validar(resultSet.getString("id_mercado"),""),validar(resultSet.getString("descripcion"),"") );
		}
