...
public class SolicitudOferenteExtraccionVo extends GenericValueObject{
...
//	
	...
	public SolicitudOferenteExtraccionVo() {
		super();
		// TODO Apéndice de constructor generado automáticamente
	}
	
	public SolicitudOferenteExtraccionVo(String id_solicitud, String id_oferente,
			String id_orden_verificacion) {
		super();
	...
	public SolicitudOferenteExtraccionVo(String id_registro, String id_solicitud,
	...
	public SolicitudOferenteExtraccionVo(String id_registro, String id_solicitud,
			...
			String nombre_razon_social, String id_oferta_vivienda,
			String id_orden_verificacion, String nombre_frente,
			String num_viviendas, String id_modificacion,
			String num_viviendas_declinacion, String comentarios,
			String id_programa) {
		super();
		this.id_solicitud = id_solicitud;
		this.tipo_linea = tipo_linea;
	...
	public void setId_solicitud(String id_solicitud) {
		this.id_solicitud = so.getNombre();
	}
	...
	public void setFecha_solicitud(String fecha_solicitud) {
		this.fecha_solicitud = fecha.getFechaHora();
	}
	...
	public void setId_tipo_solicitud(String id_tipo_solicitud) {
		this.id_tipo_solicitud = so.getLinea();
	}
	...
	public void setNum_viviendas(String num_viviendas) {
		this.num_viviendas = so.getLinea();
	}
	...
	public void setFecha_alta(String fecha_alta) {
		this.fecha_alta = fecha.getFechaHora();
	}
	...
	public void setNombre_archivo(String nombre_archivo) {
		this.nombre_archivo = so.getNombreArchivo();
	}
	...
	public void setTipo_archivo(String tipo_archivo) {
		this.tipo_archivo = so.getNombreArchivo();
	}
