 ...
 *
 */
@Repository("CatalogoTipoSancionDao")
public class CatalogoTipoSancionDao extends AbstractDao<EstatusVo> {
	
	
	
	private static String FIND = " SELECT * FROM cat_tipo_sancion WITH(NOLOCK)";
	...
	private class CatalogoEstatusMapper implements RowMapper<EstatusVo>
	{
		...
		public EstatusVo mapRow(ResultSet resultSet, int fetch) throws SQLException {
			...
			return new EstatusVo( resultSet.getInt("id_tipo_sancion"),
