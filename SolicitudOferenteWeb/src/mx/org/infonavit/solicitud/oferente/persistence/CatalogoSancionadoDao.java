 ...
 *
 */
@Repository("CatalogoSancionadoDao")
public class CatalogoSancionadoDao extends AbstractDao<EstatusVo> {
	
	
	
	private static String FIND = " SELECT * FROM cat_sancionado WITH(NOLOCK)";
	...
	private class CatalogoEstatusMapper implements RowMapper<EstatusVo>
	{
		...
		public EstatusVo mapRow(ResultSet resultSet, int fetch) throws SQLException {
			...
			return new EstatusVo( resultSet.getInt("id_sancionado"),
