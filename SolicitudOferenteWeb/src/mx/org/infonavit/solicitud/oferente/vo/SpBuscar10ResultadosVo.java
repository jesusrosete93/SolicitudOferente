...
public class SpBuscar10ResultadosVo extends GenericValueObject {
	...
	public SpBuscar10ResultadosVo() {
		super();
	}
	
	
	public SpBuscar10ResultadosVo(String fechaInicio, String fechaFin,
			String parametro) {
		super();
