...
Solicitud de Declinacion.
</p>
<form id="inicioForm" action="welcome.htm"></form>
<form:form id="solicitudOferenteDeclinacionForm" modelAttribute="solicitudDeclinacion"> 
...
Datos oferente
		...
		<tr>
	     <td  colspan="2"><spring:message code="solicitud.oferente.titulo.generico.atributo.idOferente" /></td>
	  	  <td  >
	  	  <form:input path="id_oferente" cssClass="k-textbox" cssStyle="width: 150%" />	  	  	
	  	  </td>
	  	  
	  	<td align="right" colspan="2"><spring:message code="avaluos.titulo.generico.rfc" /></td>
	  	  <td  ><form:input cssClass="k-textbox" path="rfc_oferente"  cssClass="k-textbox" /></td>
	  	  
	  	  
  	 	<tr>
	     <td  colspan="2"><spring:message code="solicitud.oferente.titulo.generico.genera.nombreOferente" /></td>
...
Datos de oferta
  	 	...
  	 	<tr>
	     <td  colspan="2"><spring:message code="solicitud.oferente.titulo.generico.atributo.idOferta" /></td>
	  	  <td colspan="2" ><form:input path="id_oferta_vivienda" cssClass="k-textbox" cssStyle="width: 145%" /></td>

  	 	<tr>
  	 	
  	 	<tr>
  	 	 <td  colspan="2" width="97"><spring:message code="solicitud.oferente.titulo.generico.atributo.ordenVerificacion" /></td>
	  	  <td colspan="2" ><form:input cssClass="k-textbox" path="id_orden_verificacion" cssStyle="width: 145%" /></td>
  	 	</tr>
  	 	
	     <td  colspan="2"><spring:message code="solicitud.oferente.titulo.generico.atributo.nombreFrente" /></td>
	  	  <td colspan="2"><form:input cssClass="k-textbox" path="nombre_frente" cssStyle="width: 145%" /></td>

  	 	</tr>
  	 	
  	 	<tr>
  	 	<td  colspan="2" ><spring:message code="solicitud.oferente.titulo.generico.atributo.numeroViviendas" /></td>
		<td align="left" colspan="2"><form:input cssClass="k-textbox" path="num_viviendas"  cssStyle="width: 145%" /></td>
  	 	</tr>
...
<td ><p style="font-family: times, serif; font-size:11pt; font-style:normal;" align="center">
...
Datos de declinación
  	 	  	 		...
  	 	  	 		<tr>
	     <td  colspan="2"><spring:message code="solicitud.oferente.titulo.generico.atributo.numeroPaquetes" /></td>
	  	  <td  ><form:input cssClass="k-textbox" path="id_paquete"  /></td>

	<td  colspan="2"><spring:message code="solicitud.oferente.titulo.generico.atributo.numeroActualViviendas" />
	</td>
	<td  ><form:input cssClass="k-textbox" path=""  /></td>
...
<td  colspan="2" ><spring:message code="solicitud.oferente.titulo.generico.atributo.viviendasDeclinar" /></td>
...
<td ><p style="font-family: times, serif; font-size:10pt; font-style:normal;" align="center"></p>
  	 ...
  	 <td ><p style="font-family: Arial, sans-serif; font-size:10pt; font-style:small;" align="center">Comentarios</p>
  	 </td>
  	 	</tr>
  	 	...
  	 	<tr>
	  	  <td colspan="7" align="center"> <textarea name="comentarios"rows="3" cols="95">Escribe aquí tus comentarios</textarea></td>
  	 		...
  	 		<div  >
       <td > <textarea hidden=""  name="id_tipo_solicitud">3</textarea ></td>
       </div>
		...
		$("#nuevaBusqueda").click(function(){
            ...
            $("#busqueda").click(function(e){
            	 ...
            	 if( gridEcoTec!=null)
            	 {
      			 ...
      			 $.ajax({
						type: 'POST'
						,url:'/SolicitudOferenteWeb/insertarSolicitudDeclinacion.json'
						,data: $('#solicitudOferenteDeclinacionForm').serialize()
						,dataType: "json"
						,beforeSend: function( )
						{
						    $("#errores").empty();
