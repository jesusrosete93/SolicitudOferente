...
<body>
<span class="tituloAzulGrande">Consultas de Oferentes</span>
...
<div>
	<table align="center">
		<tr>
	     <td align="right" colspan="2">Paquetes</td>
	  	  <td align="left" >
	  	  <form:input path="cveEcoTecnologia" cssClass="k-textbox"  />	  	  	
	  	  </td>
  	 	</tr>
  	 	<tr>
	     <td align="right" colspan="2">Estatus paquetes</td>
	     ...
	     <td align="right" colspan="2">RFC</td>
  	 	...
  	 	<tr>
	     <td align="right" colspan="2">Numero Paquete</td>
	  	  <td align="left" ><form:input cssClass="k-textbox" path="desarrollador"  /></td>
  	 	</tr>
  	 	<tr>
	     <td align="right" colspan="2">Numero Oferta</td>
	  	  <td align="left" ><form:input cssClass="k-textbox" path="desarrollador"  /></td>
  	 	</tr>
  	 	<tr>
	     <td align="right" colspan="2">Nombre Frente</td>
	  	  <td align="left" ><form:input cssClass="k-textbox" path="desarrollador"  /></td>
  	 	</tr>
  	 	<tr>
	     <td align="right" colspan="2">Estatus</td>
	  	  <td align="left" ><form:input cssClass="k-textbox" path="desarrollador"  /></td>
  	 	</tr>
  	 	<tr>
